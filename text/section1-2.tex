...
このJSONデータ変数json\_dataに格納しpythonで参照すると次のようになります。
\begin{listing}{1}
json_data["name"] ⇒　"佐々木"
...
\end{codebox}
\end{pabox}
この時json\_dataはdict型（辞書型）となり、json\_data["score"]はlist型となります。
